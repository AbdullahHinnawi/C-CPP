...
Matkakortti::Matkakortti(const Matkakortti  &kopioitava) {

    ptrOmistaja = ::new string;
    ptrSaldo = ::new float;

    *ptrOmistaja = *kopioitava.ptrOmistaja; // tai esim.  *ptrOmistaja = *(kopioitava.ptrOmistaja);
    *ptrSaldo = *kopioitava.ptrSaldo;

    cout << "Kopiointi konstruktori on kutsuttu!" << endl;
}
